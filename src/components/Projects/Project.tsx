...
export const Project = ({ project, link, image, description, index }: ProjectProps) => {
  ...
  return (
    <div className='flex flex-col gap-[14px]'>
      ...
      <div className='flex flex-col w-10/12 h-auto md:w-[370px] md:h-[314.82px] rounded-lg
        ...
        <div className="flex flex-col items-center md:items-start z-10 px-8 py-4 gap-[21.82px]
        text-secondary-300 border-t border-primary-100">
          ...
          <Link
            ...
            className='w-full md:w-[129px] h-[38px] bg-primary-100 rounded-md text-secondary-100
