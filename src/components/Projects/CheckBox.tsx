"use client"
import { Technology, useTechSelection } from '@/hooks/useTechSelection'
  ...
  return (
    <input
      ...
      className={twMerge(`
        ...
        checked:before:opacity-[0.16] checked:after:absolute checked:after:mt-px 
        checked:after:ml-[0.25rem] checked:after:block checked:after:h-[.6875rem] checked:after:w-[.375rem] 
        ...
        focus:after:z-[1] focus:after:block focus:after:h-[.6875rem] focus:after:w-[.375rem]  
        ...
        checked:focus:after:h-[.6875rem] checked:focus:after:w-[.375rem]  
